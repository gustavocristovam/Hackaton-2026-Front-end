...
export const checkinDtoSchema = z.object({
  ...
  sono: z.unknown().optional(),
  agua: z.unknown().optional(),
  treino: z.unknown().optional(),
  humor: z.unknown().optional(),
  alimentacao: z.unknown().optional(),
  energia: z.unknown().optional(),
